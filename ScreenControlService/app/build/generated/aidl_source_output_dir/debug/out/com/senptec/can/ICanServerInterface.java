...
public interface ICanServerInterface extends android.os.IInterface
{
  ...
  public static class Default implements com.senptec.can.ICanServerInterface
  {
    ...
    @Override public void requestRecordFileList(java.lang.String packageName, java.lang.String tag, int csi, int channel, long startTime, long endTime) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements com.senptec.can.ICanServerInterface
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_requestRecordFileList:
        {
          data.enforceInterface(descriptor);
          java.lang.String _arg0;
          _arg0 = data.readString();
          ...
          long _arg5;
          _arg5 = data.readLong();
          this.requestRecordFileList(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
          reply.writeNoException();
          return true;
        }
        default:
    ...
    private static class Proxy implements com.senptec.can.ICanServerInterface
    {
      ...
      @Override public void requestRecordFileList(java.lang.String packageName, java.lang.String tag, int csi, int channel, long startTime, long endTime) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_requestRecordFileList, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().requestRecordFileList(packageName, tag, csi, channel, startTime, endTime);
            return;
          }
          _reply.readException();
        }
    ...
    static final int TRANSACTION_requestRecordFileList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
  ...
  public void requestRecordFileList(java.lang.String packageName, java.lang.String tag, int csi, int channel, long startTime, long endTime) throws android.os.RemoteException;
}
