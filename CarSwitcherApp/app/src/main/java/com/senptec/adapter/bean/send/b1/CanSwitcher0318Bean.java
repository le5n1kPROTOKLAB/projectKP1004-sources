...
public class CanSwitcher0318Bean extends ByteCanBaseBean {
    ...
    private static final byte VOLUME_UP_FLAG_ON = (byte) 0b00000001 << 2;    // Бит 2
    private static final byte VOLUME_DOWN_FLAG_ON = (byte) 0b00000001 << 3;  // Бит 3
    ...
    // Добавляем методы для Volume Up
    public void setVolumeUp(boolean isOn) {
        if (isOn) {
            bytes[0] = (byte) (getByte0() | VOLUME_UP_FLAG_ON);
        } else {
            bytes[0] = (byte) (getByte0() & ~VOLUME_UP_FLAG_ON);
        }
    ...
    public boolean getVolumeUp() {
        return VOLUME_UP_FLAG_ON == (byte) (getByte0() & VOLUME_UP_FLAG_ON);
    }
    ...
    public void setVolumeDown(boolean isOn) {
        if (isOn) {
            bytes[0] = (byte) (getByte0() | VOLUME_DOWN_FLAG_ON);
        } else {
            bytes[0] = (byte) (getByte0() & ~VOLUME_DOWN_FLAG_ON);
        }
    }

    public boolean getVolumeDown() {
        return VOLUME_DOWN_FLAG_ON == (byte) (getByte0() & VOLUME_DOWN_FLAG_ON);
    }
    ...
    public String toString() {
        return super.toString() + "\n" +
                ...
                "Volume +: " + Utils.getOnOff(getVolumeUp()) + "\n" +
                "Volume -: " + Utils.getOnOff(getVolumeDown()) + "\n" +
                "}";
    }
}
